...
const App = () => {
  ...
  // Properly initialize the grid with independent arrays for each row
  ...
  const initializeSounds = () => {
    if (!isAudioInitialized) {
      ...
      // Set default sound volume for all sounds
      cellClickSound.current.volume = 0.1;
      waveEffectSound.current.volume = 0.1;
      buttonClickSound.current.volume = 0.1;
